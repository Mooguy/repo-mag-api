...
- **GitHub**: Tree API (no clone). 
- **Ignores**: binaries/locks/`node_modules/`. 
- **Prioritizes**: README/configs + top-3 src previews (~12k chars) Fits LLM context, captures purpose/tech/structure efficiently.
